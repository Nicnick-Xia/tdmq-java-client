...
public class SimpleProducerAndConsumer {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(SimpleProducerAndConsumer.class);
	...
	private static void invoke() throws PulsarClientException {
        ...
        Producer<byte[]> producer = client.newProducer()
                .topic(Config.TOPIC)
                .create();
        LOGGER.info(">> pulsar producer created.");
        ...
        for (int i = 0; i < 5; i++) {
            ...
            LOGGER.info("deliver msg " + msgId + ",value:" + value);
        }
        //关闭生产者
        producer.close();
