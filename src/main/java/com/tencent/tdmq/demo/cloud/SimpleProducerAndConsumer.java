...
public class SimpleProducerAndConsumer {
	...
	private static final Logger log = LoggerFactory.getLogger(SimpleProducerAndConsumer.class);
	...
	private static void invoke() throws PulsarClientException {
        ...
        Producer<byte[]> producer = client.newProducer()
                .topic(Config.TOPIC)
                .create();
        log.info("pulsar producer created");
        ...
        for (int i = 0; i < 5; i++) {
            ...
            log.info("deliver msg {}, value:{}", msgId, value);
        }
        //关闭生产者
        producer.close();
